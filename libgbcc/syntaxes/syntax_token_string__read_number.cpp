...
void
syntax_token_string::
read_binary_number(text::iterator&  it) noexcept
{
  uint64_t  n = 0;
...
void
syntax_token_string::
read_octal_number(text::iterator&  it) noexcept
{
  uint64_t  n = 0;
...
void
syntax_token_string::
read_decimal_number(text::iterator&  it) noexcept
{
  uint64_t  n = 0;
...
void
syntax_token_string::
read_hexadecimal_number(text::iterator&  it) noexcept
{
  uint64_t  n = 0;
...
void
syntax_token_string::
read_floating_point_number(text::iterator&  it, uint64_t  i) noexcept
{
...
void
syntax_token_string::
read_number_that_begins_by_zero(text::iterator&  it) noexcept
{
  auto  c = *++it;
...
void
syntax_token_string::
read_number(text::iterator&  it) noexcept
{
